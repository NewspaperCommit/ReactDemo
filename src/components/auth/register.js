        ...
        <Card className="loginBox p-4">
            <Form>
                <Row form>
                    ...
                    <Col sm="12" className="form-group">
                        <PasswordBox Name="New Password" Placeholder="New Password" handleVal={(val) => setPassword(val)} ref={passRef} />
                    </Col>
                    <Col sm="12" className="form-group">
                        <ConfirmPasswordBox Name="Confirm Password" Placeholder="Confirm Password" match={password} handleVal={(val) => setConfPassword(val)} ref={cnfPassRef} />
                    </Col>

                    <Col sm="12" className="form-group">
                        <TextBox Name="Full Name" Placeholder="Enter Full Name" handleVal={(val) => setFullname(val)} ref={nameRef} />

                    </Col>
                    <Col sm="12" className="form-group">
                        <TextBox Name="Access Code" Placeholder="Enter Service Access Code" handleVal={(val) => setAccesscode(val)} ref={accessRef} />
                    </Col>
                </Row>
